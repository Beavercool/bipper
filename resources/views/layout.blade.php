...
<body class="text">
    <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-3 bg-dark text-white border-bottom">
      <a href="/" class="d-flex align-items-center text-white text-decoration-none">
        ...
        <span class="fs-4">Bip-Bot</span>
      </a>

      <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        <a class="me-3 py-2 text-white text-decoration-none" href="/main">Features</a>
        <a class="me-3 py-2 text-white text-decoration-none" href="/about">About</a>
        <a class="me-3 py-2 text-white text-decoration-none" href="/constructor">Constructor</a>
        <a class="py-2 text-white text-decoration-none" href="/pricing">Pricing</a>
      </nav>
